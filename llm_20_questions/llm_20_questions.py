...
# Load the keywords from the uploaded keywords.py file
...
# Execute the file content to extract the KEYWORDS_JSON variable
namespace = {}
exec(file_content, namespace)

# Assuming the content assigns a variable named KEYWORDS_JSON
keywords_list = json.loads(namespace['KEYWORDS_JSON'])

# Now use keywords_list instead of KEYWORDS_JSON
